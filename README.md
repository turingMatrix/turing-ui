...
<p align="center">
  ...
  <a href="https://cdnjs.com/libraries/turing-ui">
    <img src="https://img.shields.io/cdnjs/v/turing-ui.svg">
  </a>
  <a href="https://www.npmjs.org/package/turing-ui">
    <img src="https://img.shields.io/npm/v/turing-ui.svg">
  </a>
  <a href="https://npmcharts.com/compare/turing-ui?minimal=true">
    <img src="http://img.shields.io/npm/dm/turing-ui.svg">
  </a>
  <br>
  <a href="http://img.badgesize.io/https://unpkg.com/turing-ui/lib/index.js?compression=gzip&label=gzip%20size:%20JS">
    <img src="http://img.badgesize.io/https://unpkg.com/turing-ui/lib/index.js?compression=gzip&label=gzip%20size:%20JS">
  </a>
  <a href="http://img.badgesize.io/https://unpkg.com/turing-ui/lib/theme-chalk/index.css?compression=gzip&label=gzip%20size:%20CSS">
    <img src="http://img.badgesize.io/https://unpkg.com/turing-ui/lib/theme-chalk/index.css?compression=gzip&label=gzip%20size:%20CSS">
  </a>
  <a href="#backers">
...
## Install
```shell
npm install turing-ui -S
```

## Quick Start
``` javascript
import Vue from 'vue'
import Element from 'turing-ui'
