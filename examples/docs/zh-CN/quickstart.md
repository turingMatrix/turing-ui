...
```javascript
import Vue from 'vue';
import ElementUI from 'turing-ui';
import 'turing-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'turing-ui';
import App from './App.vue';
